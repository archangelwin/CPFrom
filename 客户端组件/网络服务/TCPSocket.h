...
//代理类型
//#define enProxyServerType::ProxyType_None					0									//没有代理
//#define enProxyServerType::ProxyType_Http					1									//代理类型
//#define enProxyServerType::ProxyType_Socks4				2									//代理类型
//#define enProxyServerType::ProxyType_Socks5				3									//代理类型
//
////代理描述
...
public:
	...
	//设置代理
	virtual BOOL __cdecl SetProxyServerInfo(BYTE cbProxyType, tagProxyServer ProxyServerInfo);

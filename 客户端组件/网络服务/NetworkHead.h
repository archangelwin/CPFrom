#ifndef NETWORK_SERVICE_HEAD_FILE
#define NETWORK_SERVICE_HEAD_FILE
...
//模块定义
#ifndef _DEBUG
	#define NETWORK_SERVICE_DLL_NAME	TEXT("BBSocket.dll")		//组件 DLL 名字
#else
	#define NETWORK_SERVICE_DLL_NAME	TEXT("BBSocketD.dll")		//组件 DLL 名字
#endif
...
public:
	...
	//设置代理
	virtual BOOL __cdecl SetProxyServerInfo(BYTE cbProxyType, tagProxyServer ProxyServerInfo)=NULL;
...
interface INetworkManager : public IUnknownEx
{
	...
	//代理测试
	virtual DWORD __cdecl ProxyServerTesting(enProxyServerType ProxyServerType, const tagProxyServer & ProxyServerInfo)=NULL;
};

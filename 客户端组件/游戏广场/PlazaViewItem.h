...
protected:
	...
	CSkinButton						m_btGetPrize;						//网页按钮
	CSkinButton						m_btWebHome;						//网页按钮

	CSkinButton						m_btGoodNum;						//网页按钮
	CSkinButton						m_btVIP;				    		//网页按钮
	CSkinButton						m_btMobileGame;						//网页按钮

	//控件变量
protected:
	CToolTipCtrl					m_ToolTipCtrl;						//提示控件
	CPlazaBrowser					m_PlazaBrowser;						//浏览控件
//	CPlazaBrowser                   m_PlazaMessage;                     //消息控件
...
public:
	...
	void SetMainUrl(CString sMainUrl){m_sMainUrl = sMainUrl;};
	//获取实例

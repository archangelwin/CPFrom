...
//游戏属性
typedef CMap<WORD,WORD,CGameKindInfo *,CGameKindInfo * &> CGameKindInfoMap;
...
public:
	WORD nKindID;
	CString sKindTypePath;
	CString sStarLevelPath;
};
...
public:
	//设置接口
	VOID SetServerListDataSink(IServerListDataSink * pIServerListDataSink,IServerListDataSink * pIServerListDataMatchSink);
...
public:
	...
	bool InsertGameKinfInfo(CGameKindInfo *pGameKindInfo);
...
public:
	...
	CGameKindInfo * SearchGameKindInfo(WORD wKindID);

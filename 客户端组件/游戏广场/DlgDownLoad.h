...
#define DOWN_LOAD_LINK_SUCESS			6								//链接成功
...
protected:
	...
	//文件信息
protected:
	CString                         m_sDownLoadUrl;                     //下载地址
	CString                         m_sDownLoadFileName;                //下载文件
...
public:
	...
	bool CloseDownLoad();
	//执行下载
	bool PerformDownLoad(LPCTSTR pszClientName, WORD wKindID, WORD wServerID,LPCTSTR szProcessName);
	bool PerformDownLoad(LPCTSTR pszClientName, LPCTSTR szDownloadIP,LPCTSTR szProcessName);

	//状态接口
public:
	//下载异常
	virtual bool OnDownLoadError(enDownLoadError DownLoadError,INT nErrorCode,CString sDescrible);
	//下载状态
...
protected:
	...
	CString                         m_sHostDX;                          //电信ip
	CString                         m_sHostWT;                          //网通ip
	int                             m_nDownLoadType;                   //下载类型
...
protected:
	...
	CSkinButton                     m_btDownLoadDX;
	CSkinButton                   	m_btDownLoadWT;

	CSkinHyperLink                  m_webDownload;
	CSkinHyperLink                  m_webDownload1;
...
protected:
	...
	VOID OnBnClickedWT();
	//网页下载游戏
	VOID OnBnClickedWebGameDownLowd();

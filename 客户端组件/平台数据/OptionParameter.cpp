...
VOID CParameterGlobal::LoadParameter()
{
	...
	if (RegOptionItem.OpenRegKey(REG_PROXY_SERVER_INFO,false)==true)
	{
		...
		//读取参数
		m_cbProxyType=(BYTE)RegOptionItem.GetValue(TEXT("ProxyType"),enProxyServerType::ProxyType_None);
		...
		{
		case enProxyServerType::ProxyType_None:
		case enProxyServerType::ProxyType_Http:
		case enProxyServerType::ProxyType_Socks4:
		case enProxyServerType::ProxyType_Socks5: { break; }
		default: { m_cbProxyType=enProxyServerType::ProxyType_None; break; }
		}
	}

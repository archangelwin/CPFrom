...
public:
	...
	VOID SetCustomColumn(int nColumn);
	VOID SetListColor(COLORREF crTitle, COLORREF crListTX, COLORREF crListBK,COLORREF crListSelBK);
	VOID SetHeadColor(COLORREF crHeadTitle);

...
{
	CPngImageSB						ImageTL;							//位图对象
	CPngImageSB						ImageTM;							//位图对象
	CPngImageSB						ImageTR;							//位图对象
	CPngImageSB						ImageML;							//位图对象
	CPngImageSB						ImageMR;							//位图对象
	CPngImageSB						ImageBL;							//位图对象
	CPngImageSB						ImageBM;							//位图对象
	CPngImageSB						ImageBR;							//位图对象
};

...
#define DS_STRETCH_ALL              0x00000001L
#define DS_TRANSPARENT              0x00000002L
...
public:
	...
	//绘制皮肤
public:
	bool DrawSkin(CDC* pDC, LPRECT lpRect, int xSrc, int ySrc, int nSrcWidth, int nSrcHeight, UINT uFlags, 
		int left, int top, int right, int bottom, COLORREF crTransparent=RGB(255,0,255));

	bool DrawSkin(CDC* pDC, LPRECT lpRect, UINT uFlags, int left, int top, int right, int bottom,

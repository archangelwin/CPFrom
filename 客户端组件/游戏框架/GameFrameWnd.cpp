...
VOID CGameFrameWnd::RectifyControl(INT nWidth, INT nHeight)
{
	...
	//控制按钮
	DeferWindowPos(hDwp,m_btOption,NULL,m_nScrollXMax-179,4,0,0,uFlags|SWP_NOSIZE);
	DeferWindowPos(hDwp,m_btMuteContrl,NULL,m_nScrollXMax-133,4,0,0,uFlags|SWP_NOSIZE);

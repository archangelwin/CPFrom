...
#include <C:\Program Files (x86)\Microsoft Visual Studio 9.0\VC\ce\atlmfc\src\mfc\occimpl.h>
...
{
	CGameFrameApp * ptheApp=(CGameFrameApp *)AfxGetApp();
	IDispatch * pIDispatch=(IDispatch *)ptheApp->m_pIDispatch;
	pIDispatch->AddRef();

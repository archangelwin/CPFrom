...
bool CClientKernel::InitClientKernel(LPCTSTR lpszComLine)
{
	...
	if (m_ProcessControlModule->SetProcessControlSinks(QUERY_ME_INTERFACE(IUnknownEx))==false) return false;
...
//进程数据
bool CClientKernel::OnProcessControlDatas(WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize, HWND hWndSend)
{
	//效验有效

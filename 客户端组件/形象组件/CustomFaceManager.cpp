...
//下载异常
bool CCustomFaceManager::OnDownLoadError(enDownLoadError DownLoadError,INT nErrorCode,CString sDescrible)
{
	//状态效验
...
bool CCustomFaceManager::PerformDownLoad(DWORD dwUserID, DWORD dwCustomID)
{
	...
	_sntprintf(szCustomFace,CountArray(szCustomFace),TEXT("%s/CustomFace.aspx?UserID=%ld&CustomID=%ld"),pGlobalServer->GetPlatformServer(3),dwUserID,dwCustomID);

...
//登录任务
class CMissionLogon : public CDlgStatus, public CMissionItem, public IStatusViewSink/*,public CDialog*/
{
	//友元定义
...
public:
	//获取对象
	static CMissionLogon * GetInstance() 
	{ 
		if (m_pMissionLogon == NULL)
		{
			m_pMissionLogon = new CMissionLogon;
		}
		return m_pMissionLogon; 
	}

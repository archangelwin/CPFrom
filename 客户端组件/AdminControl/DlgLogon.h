...
public:
	...
	//控件变量
public:
	CButton						m_btQuit;							//退出按钮
	CButton						m_btEnter;							//登录按钮
	CButton						m_btOption;							//设置按钮
	CButton						m_btRegister;						//注册按钮
	CButton						m_btDeleteRecord;					//删除按钮
...
protected:
	...
	//按钮控件
protected:
	CButton						m_btLogonLink1;						//连接按钮
	CButton						m_btLogonLink2;						//连接按钮
	CButton						m_btLogonLink3;						//连接按钮
	CButton						m_btLogonLink4;						//连接按钮

	//特殊控件
protected:
	CTabCtrl					m_TabControl1;						//登录模式

...
// 		const CString& Channel,const CString& szLastOut,const CString& szLastIn,const CString& szFixScore)
// 		:m_Nub(Nub)
// 		,m_Event(Event)
// 		,m_RoomID(RoomID)
// 		,m_GameID(GameID)
...
// 
// 		case 12: { static CString title12(L"换牌概率"); return title ? title12 : m_ChangeCardPro; }
// 
// 
// 		case 13: { static CString title13(L"充值金额"); return title ? title13 : m_Recharge; }
// 		case 14: { static CString title14(L"桌号"); return title ? title14 : m_Table; }
// 		case 15: { static CString title15(L"设置固定输赢分数"); return title ? title15 : m_szFixScore;}
// 
// 		case 16: { static CString title16(L"最后一次转出"); return title ? title16 : m_szLastOut;}
// 		case 17: { static CString title17(L"最后一次转入"); return title ? title17 : m_szLastIn;}
// 
...
// 		case 18: { static CString title18(L"累计输赢金币"); return title ? title18 : m_WinLoseGold; }
// 		case 19: {static CString title19(L"当日输赢金币"); return title ? title19 : m_TodayWLGold; }
// 		case 20: {static CString title20(L"设置后输赢金币"); return title ? title20 : m_SetAfterScore; }
// 		case 21: { static CString title21(L"开始时间"); return title ? title21 : m_StartTimer; }
// 		case 22: { static CString title22(L"赢最高"); return title ? title22 : m_WinHighest; }
// 		case 23: { static CString title23(L"输最高"); return title ? title23 : m_LoseHighest; }
// 				 // 		case 20: { static CString title20(L"换牌概率"); return title ? title20 : m_ChangeCardPro; }
// 		case 24: { static CString title24(L"预警赢"); return title ? title24 : m_WarningWin; }
// 		case 25: { static CString title25(L"预警输"); return title ? title25 : m_WarningLose; }
// 		case 26: { static CString title26(L"赢局"); return title ? title26 : m_GameWin; }
// 		case 27: { static CString title27(L"输局"); return title ? title27 : m_GameLose; }
// 
...
// 		case 28: { static CString title28(L"IP"); return title ? title28 : m_IPAddress;}
// 		case 29: { static CString title29(L"机器码"); return title ? title29 : m_Machine;}
// 		default:{ static CString emptyStr; return emptyStr; }
// 		}
// 	}
// 
// 	int  GetColCount() const { return 30; }
// };

class COnLineSortList : public CGridListCtrlGroups, public IServerUserInfoDataSink
{
public:
	COnLineSortList(void);
	~COnLineSortList(void);
public:
	bool                m_IsFirstList;

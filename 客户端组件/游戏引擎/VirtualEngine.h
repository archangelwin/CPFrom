...
public:
	//绘画窗口
	bool DrawWindows(CD3DDevice * pD3DDevice){return true;}
	//消息处理
	bool DefWindowProc(UINT uMessage, WPARAM wParam, LPARAM lParam){return true;}
	//消息解释
	bool PreTranslateMessage(UINT uMessage, WPARAM wParam, LPARAM lParam){return true;}
...
private:
	//获取窗口
	CVirtualWindow * SwitchToWindow(INT nXMousePos, INT nYMousePos){return NULL;}
	//获取窗口
	CVirtualWindow * SwitchToWindow(CVirtualWindow * pVirtualWindow, INT nXMousePos, INT nYMousePos){return NULL;}
};

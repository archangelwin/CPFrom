...
public:
	//重置设备
	bool ResetD3DDevice(){return true;}
	//渲染设备
	bool RenderD3DDevice(){return true;}
	//创建设备
	bool CreateD3DDevice(HWND hWndDevice, ID3DDeviceSink * pID3DDeviceSink){return true;}

	//渲染状态
public:
	//渲染属性
	HRESULT SetRenderState(D3DRENDERSTATETYPE State, DWORD Value){return 0;}
	//渲染属性
	HRESULT GetRenderState(D3DRENDERSTATETYPE State, DWORD & Value){return 0;}

...
public:
	...
	VOID DeleteWindow(){}
	//激活窗口
	bool ActiveWindow(CRect & rcWindow, DWORD dwStyle, UINT uWindowID, CVirtualEngine * pVirtualEngine, CVirtualWindow * pParentWindow){return true;}
...
public:
	//下属窗口
	bool IsChildWindow(CVirtualWindow * pVirtualWindow){return true;}

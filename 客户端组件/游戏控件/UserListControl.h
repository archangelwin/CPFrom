...
#define COLOR_SELECT_BK				RGB(163,218,249)					//背景颜色
#define COLOR_NORMAL_TX				RGB(218,45,3)						//字体颜色
#define COLOR_NORMAL_BK				RGB(229,239,246)					//背景颜色

//默认颜色
#define COLOR_MYSELF_TX				RGB(15,91,152)						//字体颜色
#define COLOR_MYSELF_BK				RGB(174,220,204)					//背景颜色

#define COLOR_MASTER_TX				RGB(95,86,255)						//字体颜色
#define COLOR_MASTER_BK				RGB(253,159,158)					//背景颜色

#define COLOR_MEMBER_TX				RGB(218,45,3)						//字体颜色
#define COLOR_MEMBER_BK				RGB(222,239,246)					//背景颜色

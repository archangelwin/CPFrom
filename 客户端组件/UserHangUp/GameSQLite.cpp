...
CString GameSQLite::GetSQLModuleDir() 
{ 
...
void GameSQLite::GB2312ToUTF_8(CString& pOut,char *pText, int pLen)
{
	char buf[4];
	int nLength = pLen* 3;
...
void GameSQLite::Gb2312ToUnicode(wchar_t* pOut,char *gbBuffer)
{
	::MultiByteToWideChar(CP_ACP,MB_PRECOMPOSED,gbBuffer,2,pOut,1);
}

void GameSQLite::UnicodeToUTF_8(char* pOut,wchar_t* pText)
{
...
bool GameSQLite::ConnectDatabase()
{
...
bool GameSQLite::ExcuteQuery(const CString &command)
{
	if (m_open == false)
	{
		ConnectDatabase();

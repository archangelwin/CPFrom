...
public:
	//头像索引
	virtual WORD GetFaceID() 
	{ 
		DWORD faceID;
		SCORE nUserScore;
		nUserScore = m_UserInfo.lScore;
		if (nUserScore==0)
			faceID=0;
		...
		if (m_UserInfo.cbGender == 0)
		{
			faceID += 13;
		}
		return faceID/*m_UserInfo.wFaceID*/; 
	}
	//自定索引
...
public:
	//获取排名
	virtual WORD GetMatchRank(){return m_UserInfo.dwRank;}
	//获取比赛编号
	virtual SCORE GetMatchNo(){return m_UserInfo.dwMatchNo;}
};
...
//	CClientUserItemArray            m_UserItemMatch;//ccy20141208比赛数组

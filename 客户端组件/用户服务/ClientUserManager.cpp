...
//	UserScore.dwRank=pUserInfo->dwRank;//ccy20141205
//	UserScore.dwMatchNo=pUserInfo->dwMatchNo;//ccy20141208
...
// 	pUserInfo->dwRank=pUserScore->dwRank;//ccy20141205
// 	pUserInfo->dwMatchNo=pUserScore->dwMatchNo;//ccy20141208
...
IClientUserItem * CGameUserManager::ActiveUserItem(tagUserInfo & UserInfo, tagCustomFaceInfo & CustomFaceInfo, BYTE cbCompanion, LPCTSTR pszUserNote)
{
	...
	//比赛用户
//	 m_UserItemMatch.Add(pClientUserItem);//ccy20141208
...
// 	for (INT_PTR i=0;i<m_UserItemMatch.GetCount();i++)
// 	{
// 		CClientUserItem * pClientUserItem=m_UserItemMatch[i];
// 		if (pClientUserItem->GetUserID()==dwUserID) return pClientUserItem;
// 	}
...
// 	{
// 		CClientUserItem * pClientUserItem=m_UserItemMatch[i];
// 		if (pClientUserItem->GetUserID()==dwGameID) return pClientUserItem;
// 	}

// DES2.h: interface for the DES2 class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_DES2_H__4700A199_8D41_4079_BD61_367D4848B389__INCLUDED_)
#define AFX_DES2_H__4700A199_8D41_4079_BD61_367D4848B389__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
#include "ServiceCoreHead.h"
class SERVICE_CORE_CLASS DES2  
{
public:
		//类构造函数
         DES2(); 
		...
		void InitializeKey(CString strKey,unsigned int keyN);
		...
		void EncryptAnyLength(CString strEncry,unsigned int keyN);
...
private:
		...
		char hexCiphertextAnyLength[16384];  // 十六进制
    	char bitsCiphertextAnyLength[32768];  // 二进制
...
#endif // !defined(AFX_DES2_H__4700A199_8D41_4079_BD61_367D4848B389__INCLUDED_)

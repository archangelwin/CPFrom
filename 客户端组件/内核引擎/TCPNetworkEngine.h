...
protected:
	...
	//函数雨杰高科www.cnyjwl.com定义
public:
	//构造函数
	CServerSocketRSThread(void);
	//析构函数雨杰高科www.cnyjwl.com
...
public:
	...
	//设置参数
	virtual bool __cdecl SetServiceParameter(WORD wServicePort, WORD wMaxConnect,LPCTSTR  pszCompilation);
...
public:
	...
	//批量发送
	virtual bool __cdecl SendDataBatch(WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize, BYTE cbBatchMask);
	//关闭连接
	...
	//允许群发
	virtual bool __cdecl AllowBatchSend(DWORD dwSocketID, bool bAllow, BYTE cbBatchMask);

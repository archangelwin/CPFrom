...
//停止服务
bool /*__cdecl*/ CTCPSocketService::ConcludeService()
{
	//设置变量
	m_bService = false;
...
//////////////////////////////////////////////////////////////////////////
//配置函数
bool __cdecl CTCPSocketService::SetServiceID(WORD wServiceID)
{
...
//设置接口
bool __cdecl CTCPSocketService::SetTCPSocketEvent(IUnknownEx * pIUnknownEx)
{
	//状态判断
	if (m_bService == true)
	{
...
//////////////////////////////////////////////////////////////////////////
//关闭连接
bool __cdecl CTCPSocketService::CloseSocket()
{
	//关闭连接
...
//通知回调
void __cdecl CTCPSocketService::OnQueueServiceSink(WORD wIdentifier, void * pBuffer, WORD wDataSize)
{
	switch (wIdentifier)
	{
...
{
	//转化地址
	DWORD dwServerIP = inet_addr(CT2CA(pszServerAddr));
	if (dwServerIP == INADDR_NONE)
	{
		LPHOSTENT lpHost = gethostbyname(CT2CA(pszServerAddr));
...
//////////////////////////////////////////////////////////////////////////
//建立对象函数
extern "C" __declspec(dllexport) void * __cdecl CreateTCPSocketService(const GUID & Guid, DWORD dwInterfaceVer)
{
	//建立对象

...
//////////////////////////////////////////////////////////////////////////
//追踪信息
bool __cdecl CTraceServiceControl::TraceString(LPCTSTR pszString, enTraceLevel TraceLevel)
{
	//效验参数
	...
	_sntprintf(szTimeBuffer, sizeof(szTimeBuffer), _T("【 %04d-%02d-%02d %02d:%02d:%02d 】"), SystemTime.wYear, SystemTime.wMonth, SystemTime.wDay, SystemTime.wHour, SystemTime.wMinute, SystemTime.wSecond);

//	InsertString(szTimeBuffer, CharFormat);

	_sntprintf(szTimeBuffer, sizeof(szTimeBuffer), _T("%s%s\n"), szTimeBuffer, pszString);

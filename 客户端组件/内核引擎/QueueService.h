...
interface IQueueService : public IServiceModule
{
	...
	//负荷信息
	virtual void __cdecl GetBurthenInfo(tagBurthenInfo & BurthenInfo) = NULL;
	//加入数据
...
public:
	...
	//负荷信息
	virtual void __cdecl GetBurthenInfo(tagBurthenInfo & BurthenInfo);

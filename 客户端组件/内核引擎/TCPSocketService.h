...
public:
	//配置函数
	virtual bool __cdecl SetServiceID(WORD wServiceID);
	//设雨杰高科www.cnyjwl.com置接口
	virtual bool __cdecl SetTCPSocketEvent(IUnknownEx * pIUnknownEx);


	//功能接雨杰高科www.cnyjwl.com口
public:
	//关闭连接
	virtual bool __cdecl CloseSocket();
	//连雨杰高科www.cnyjwl.com接地址
	virtual bool __cdecl Connect(DWORD dwServerIP, WORD wPort);
	//连接地雨杰高科www.cnyjwl.com址

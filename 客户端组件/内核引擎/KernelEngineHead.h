...
#define MAX_ASYNCHRONISM_DATA		16384/*8192*/					    //异步数据
...
public:
	//时间事件
	virtual bool  PostDataBaseTimer(DWORD dwTimerID, WPARAM dwBindParameter)=NULL;
	//控制事件
...
public:
	...
	//设置参数
	virtual bool __cdecl SetServiceParameter(WORD wServicePort, WORD wMaxConnect,LPCTSTR  pszCompilation)=NULL;
...
public:
	...
	//批量发送
	virtual bool __cdecl SendDataBatch(WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize, BYTE cbBatchMask)=NULL;
...
public:
	...
	//允许群发
	virtual bool __cdecl AllowBatchSend(DWORD dwSocketID, bool bAllowBatch, BYTE cbBatchMask)=NULL;
};
...
interface ITCPSocketEvent : public IUnknownEx
{
	...
	//读取事件
	virtual bool __cdecl OnEventTCPSocketRead(WORD wServiceID, TCP_Command Command, VOID * pData, WORD wDataSize)=NULL;
};
...
public:
	...
	//读取雨杰高科www.cnyjwl.com事件
	virtual bool __cdecl OnEventTCPNetworkRead(DWORD dwSocketID, TCP_Command Command, VOID * pData, WORD wDataSize)=NULL;
};

...
//设置参数
bool __cdecl CTCPNetworkEngine::SetServiceParameter(WORD wServicePort, WORD wMaxConnect,LPCTSTR  pszCompilation)
{
	//效验状态
	if (m_bService == true)
	{
...
//批量发送
bool __cdecl CTCPNetworkEngine::SendDataBatch(WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize, BYTE cbBatchMask)
{
	//效益状态
	if (m_bService == false) return false;
...
//允许群发
bool __cdecl CTCPNetworkEngine::AllowBatchSend(DWORD dwSocketID, bool bAllow, BYTE cbBatchMask)
{

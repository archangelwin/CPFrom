...
interface IIPCRecvDataSink : public IUnknownEx
{
	...
	//异步数据
	virtual bool OnAsynchronismmData(WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize, HWND hWndSend)=NULL;
};
...
public:
	...
	//配置组件
	virtual bool SetProcessControlSinks(IUnknownEx * pIUnknownEx)=NULL;
...
{
	//进程数据
	virtual bool OnProcessControlDatas(WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize, HWND hWndSend)=NULL;
};
